...
public class UserDao {
    ...
    public String authenticate(String username, String password) {
        ...
        q.setParameter(ConstantsDao.username, username);
        try {
    ...
    public String create(User user) throws Exception {
        ...
        EntityManager em = ThreadLocalContext.get().getEntityManager();
        Query q = em.createQuery("select u from User u where u.username = :username and u.deleteDate is null");
        q.setParameter(ConstantsDao.username, user.getUsername());
        List<?> l = q.getResultList();
        if (!l.isEmpty()) {
            throw new AlreadyExistingUsernameException("AlreadyExistingUsername");
        }
    ...
    public User update(User user) {
        ...
        q.setParameter(ConstantsDao.id, user.getId());
    ...
    public User getActiveByPasswordResetKey(String passwordResetKey) {
        ...
        try {
            ...
            q.setParameter(ConstantsDao.passwordResetKey, passwordResetKey);
            return (User) q.getSingleResult();
        } catch (NoResultException e) {
            return null;
        }
    ...
    public void delete(String username) {
        ...
        q.setParameter(ConstantsDao.userId, userFromDb.getId());
        q.executeUpdate();
    }
