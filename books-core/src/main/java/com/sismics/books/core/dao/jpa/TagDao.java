...
public class TagDao {
    ...
    public void updateTagList(String userBookId, Set<String> tagIdSet) {
        ...
        q.setParameter(ConstantsDao.userBookId, userBookId);
        q.executeUpdate();
    ...
    public Tag getByName(String userId, String name) {
        ...
        q.setParameter(ConstantsDao.userId, userId);
        q.setParameter(ConstantsDao.name, name);
        try {
    ...
    public Tag getByTagId(String userId, String tagId) {
        ...
        q.setParameter(ConstantsDao.userId, userId);
        q.setParameter(ConstantsDao.tagId, tagId);
        try {
            return (Tag) q.getSingleResult();
        } catch (NoResultException e) {
            return null;
    ...
    public void delete(String tagId) {
        ...
        q.setParameter(ConstantsDao.id, tagId);
